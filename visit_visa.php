...
<html lang="en">
    ...
    <head>
        ...
        <title>SUMMIT TRUST - Visit Visa</title>
    ...
    <section class="container clearfix">
        ...
        <header class="container page_info clearfix">
            ...
            <h1 class="regular brown bottom_line">Visit Visa</h1>
        ...
        <img src="images/contents/VisitVisa_Img.png" width="940"/>
        <br/>    <br/>    <br/>  
        <div class="container">
            <p>Capital Immigration provides services ranging from single to multiple entry visas for a single person, family or group of any number with complete range of services including the consultancy.  We work with all the relevant authorities as required by Embassy policy.</p>
            <p>Visit visa service assistance range, is including all the countries with all types of visas such as tourist, business, family, study & etc.</p>
            <p>Please contact us for any inquiry and services; our highly professional staffs are always available to answer any questions you may have.</p>
     <br/>    <br/>    <br/>  
        </div>
